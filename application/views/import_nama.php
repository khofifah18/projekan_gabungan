<div class="container-fluid ">
    <div class="d-flex justify-content-center mb-4">
        <h3 class="h4 mb-0 text-gray-800" style="color: black; font-weight: bold; text-align: center;">Import Nama Barang</h3>
    </div>
            ...
            <div class="card o-hidden border-0 shadow-lg my-2">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-5">
                                <form method="post" enctype="multipart/form-data" action="<?php echo base_url('nama_barang/aksi_import_nama'); ?>">
                                    ...
                                    <div >
                                    <a href="<?php echo base_url('nama_barang') ?>" class="btn btn-secondary"><i class="fas fa-chevron-left"></i> Kembali</a>
